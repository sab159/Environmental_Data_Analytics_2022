...
year1999 <- NTL.phys.data %>% filter(year4 == 1999)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
tuesdaylake <- NTL.phys.data %>% filter(lakename == "Tuesday Lake", year4 >= 1990, year4 <= 1999) 
# can also use 'year4 %in% 1990:1999
...
Ex4 <- Ex3 %>% filter(depth == 0) %>% summarise(mean_temp = mean(temperature_C, na.rm = TRUE))
